...
export const metadata: Metadata = {
  ...
  description:
    'Tower Rush играть онлайн бесплатно — краш-игра с AI Аналитиком, который точно предсказывает этаж краша. Тренируйте стратегии в демо и переходите на реальные деньги с промокодом MARCHTOWER на 1win.',
  alternates: {
    canonical: SITE_URL,
  },
  openGraph: {
    ...
    title: 'Tower Rush играть онлайн — бесплатное демо с AI предсказателем',
    description:
      'Tower Rush играть онлайн — AI предсказывает краш. Промокод MARCHTOWER — бонус +500% на 1win.',
  },
};
  ...
  return (
    <>
      ...
      <section aria-label="О Tower Rush" className="sr-only">
        ...
        <h3>Промокод MARCHTOWER для 1win</h3>
        <p>
          Введите промокод MARCHTOWER при регистрации на 1win и получите бонус до 500% на первый
