...
export const metadata: Metadata = {
  title: 'Промокод 1win MARCHTOWER — бонус 500% при регистрации',
  description:
    'Промокод 1win MARCHTOWER при регистрации — бонус до 500% на первый депозит. Рабочий промокод 1win в 2025 году. Введите MARCHTOWER и получите максимальный бонус для Tower Rush.',
  keywords: [
    'промокод 1win',
    'промокод 1win при регистрации',
    'промокод 1win 2025',
    'промокод 1win marchtower',
  ...
  openGraph: {
    url: `${SITE_URL}/promo`,
    title: 'Промокод MARCHTOWER — бонус до 500% на 1win',
    description:
      'Введите MARCHTOWER при регистрации на 1win и получите бонус до 500% на первый депозит для игры в Tower Rush.',
  },
};

const faq = [
  {
    q: 'Что такое промокод MARCHTOWER?',
    a: 'MARCHTOWER — официальный партнёрский промокод для регистрации на платформе 1win. При использовании этого кода вы получаете увеличенный приветственный бонус до 500% на первый депозит.',
  },
  {
    q: 'Как использовать промокод MARCHTOWER?',
    a: 'Перейдите на сайт 1win по кнопке «Зарегистрироваться на 1win» выше. При заполнении формы регистрации найдите поле «Промокод» или «Реферальный код» и введите MARCHTOWER. Бонус начисляется автоматически после первого пополнения счёта.',
  },
  {
    q: 'Сколько можно получить с промокодом MARCHTOWER?',
    a: 'Промокод MARCHTOWER активирует бонус до 500% на первый депозит. Например, при пополнении на 5 000 ₽ ваш игровой баланс составит до 30 000 ₽. Точный размер бонуса зависит от суммы депозита и актуальных условий акции на сайте 1win.',
  },
  {
    q: 'Работает ли промокод MARCHTOWER в 2024-2025 году?',
    a: 'Да, промокод MARCHTOWER актуален и действует. Мы регулярно проверяем его работоспособность. Если при вводе кода возникает ошибка, убедитесь, что вводите его заглавными буквами: MARCHTOWER.',
  },
  {
    q: 'На какие игры распространяется бонус?',
    a: 'Бонус по промокоду MARCHTOWER может быть использован на слоты, краш-игры (включая Tower Rush), настольные игры и live-казино на платформе 1win. Ознакомьтесь с полными условиями вейджера на сайте 1win.',
  },
  {
  ...
  },
  {
    ...
    a: 'Убедитесь что: (1) вводите код заглавными буквами — MARCHTOWER, (2) вы создаёте новый аккаунт (промокод только для новых пользователей), (3) поле промокода заполнено до нажатия кнопки регистрации. При технических проблемах обратитесь в поддержку 1win через чат.',
  },
  {
    q: 'Есть ли ограничения по странам?',
    a: 'Промокод MARCHTOWER действителен для пользователей из стран, где платформа 1win ведёт деятельность. Уточните доступность сервиса в вашем регионе на официальном сайте 1win перед регистрацией.',
  },
  {
    q: 'Как связан Tower Rush с 1win?',
    a: 'Tower Rush — демонстрационная версия краш-игры в стиле 1win Casino. Демо-режим позволяет изучить механику, стратегии и поведение AI Аналитика перед игрой на реальные деньги. Промокод MARCHTOWER обеспечивает максимальный стартовый бонус при переходе на 1win.',
  },
  {
    q: 'Можно ли использовать промокод повторно?',
    a: 'Нет, промокод MARCHTOWER применяется один раз — при первой регистрации аккаунта на 1win. Бонус предназначен для новых игроков платформы. Повторное использование на том же аккаунте или при повторной регистрации невозможно.',
  },
];
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Промокод MARCHTOWER', item: `${SITE_URL}/promo` },
  ],
};
      ...
      <div className="min-h-full" style={{ background: '#141415' }}>
        <article className="max-w-lg mx-auto px-6 py-10 text-white">
          ...
          <h1 className="text-3xl font-black text-center mb-8 leading-tight">
            Промокод <span className="font-mono text-blue-300">MARCHTOWER</span><br />
          ...
          <div className="relative rounded-3xl overflow-hidden mb-10 shadow-2xl shadow-black/50">
            ...
            <div className="relative px-8 py-10 flex flex-col items-center gap-6 text-center">
              ...
              <p className="text-white/25 text-[11px] leading-relaxed">
                Введите MARCHTOWER в поле промокода при регистрации.
          ...
          <section className="mb-10">
            ...
            <div className="flex flex-col gap-3">
              {[
                ...
                { num: '02', title: 'Введите промокод', desc: 'При регистрации найдите поле «Промокод» и введите MARCHTOWER заглавными буквами.' },
          ...
          <section className="mb-8">
            <h2 className="text-lg font-bold mb-5 flex items-center gap-2">
              <span className="w-1 h-5 rounded-full bg-gradient-to-b from-blue-400 to-green-400 inline-block" />
              Вопросы о промокоде MARCHTOWER
            </h2>
            <div className="flex flex-col gap-3">
              {faq.map((item, i) => (
