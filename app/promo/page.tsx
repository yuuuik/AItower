...
export const metadata: Metadata = {
  title: 'Промокод 1win ADUNLOCK — бонус 500% при регистрации',
  description:
    'Промокод 1win ADUNLOCK при регистрации — бонус до 500% на первый депозит. Рабочий промокод 1win в 2025 году. Введите ADUNLOCK и получите максимальный бонус для Tower Rush.',
  keywords: [
    'промокод 1win',
  ...
  openGraph: {
    url: `${SITE_URL}/promo`,
    title: 'Промокод ADUNLOCK — бонус до 500% на 1win',
    description:
...
const faq = [
  ...
  {
    q: 'Работает ли промокод ADUNLOCK в 2024-2025 году?',
