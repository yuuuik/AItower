...
export const metadata: Metadata = {
  ...
  description:
    'Как играть в Tower Rush: правила, механика краша, что предсказывает AI Аналитик, промокод MARCHTOWER, как скачать APK. Ответы на все частые вопросы.',
  keywords: [
...
const faq = [
  ...
  { q: 'Как использовать промокод MARCHTOWER?', a: 'Для реальных денег: при регистрации на 1win введите MARCHTOWER в поле промокода — получите бонус до 500% на первый депозит. Для демо-баланса: раздел «Промокод» в меню → введите MARCHTOWER → нажмите «Применить».' },
  ...
  { q: 'Что делать когда заканчиваются попытки?', a: 'Введите MARCHTOWER в разделе «Промокод» — попытки сбросятся. Либо нажмите «Сброс» в верхней панели для полного обнуления баланса до 10 000 ₽ и 10 попыток.' },
        ...
        <article className="max-w-2xl mx-auto px-6 py-10 text-white">
          ...
          <nav aria-label="Связанные разделы" className="grid grid-cols-2 gap-3 mb-6">
            ...
            <a href={REAL_MONEY_URL} target="_blank" rel="noopener noreferrer" className="rounded-2xl border border-green-500/20 bg-green-500/5 p-4 hover:bg-green-500/10 transition-colors group">
              ...
              <p className="text-white/35 text-xs mt-0.5">1win · Промокод MARCHTOWER</p>
            </a>
          </nav>
